...
public class BlackDuckMessageBuilderTestHelper {
    ...
    public static BlackDuckService mockBlackDuckService() {
        ...
        try {
            ...
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_1, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_2, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_3, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_4, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_5, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_6, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_7, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_8, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_9, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_10, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_11, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_12, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_CVE_13, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
            mockVulnSingleResponse(VulnerabilityTestConstants.VULNERABILITY_URL_BDSA_4, mockBlackDuckService, VulnerabilityCvss3SeverityType.LOW);
